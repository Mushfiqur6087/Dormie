...
class StudentUpdateTest {
    ...
    private void updateStudentInformation(String studentToken, StudentUpdateRequest updateRequest) {
        ...
        if (updatedStudent != null) {
            ...
            assertEquals(updateRequest.getRegNo(), updatedStudent.getRegNo(), 
                "Registration number should be updated");
            assertEquals(updateRequest.getDateOfBirth(), updatedStudent.getDateOfBirth(), 
    ...
    private StudentUpdateRequest createStudentUpdateRequest() {
        ...
        updateRequest.setRegNo("REG2024001");
        updateRequest.setDateOfBirth(java.time.LocalDate.of(2000, 1, 1));
