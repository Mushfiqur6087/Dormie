...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        if (signUpRequest.getStudentId() == null) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Student ID is required!"));
        }
        if (signUpRequest.getDepartment() == null || signUpRequest.getDepartment().trim().isEmpty()) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Department is required!"));
        }
        if (signUpRequest.getBatch() == null) {
            return ResponseEntity.badRequest()
                    .body(new MessageResponse("Error: Batch is required!"));
        }
