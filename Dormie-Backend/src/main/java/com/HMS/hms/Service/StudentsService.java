...
import com.HMS.hms.Tables.Students; // Make sure this is imported
...
public class StudentsService {
    ...
    public Students updateStudentInformation(Students student, StudentUpdateRequest updateRequest) {
        ...
        if (updateRequest.getRegNo() != null) {
            student.setRegNo(updateRequest.getRegNo());
        }
        
        if (updateRequest.getDateOfBirth() != null) {
            student.setDateOfBirth(updateRequest.getDateOfBirth());
        }
