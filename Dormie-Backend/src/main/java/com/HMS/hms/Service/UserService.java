...
public class UserService {
     ...
     * @deprecated Username can be duplicated, use existsByEmail for validation instead
     */
    @Deprecated
    ...
    /**
     * Set default values for a new student (only for null/empty fields)
     * @param student the student object to update
     */
