        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 mb-8 border border-gray-100 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-gray-900 dark:text-white">Manage Complaints</h1>
                <p className="text-gray-600 dark:text-gray-300 text-lg mt-1">Administrative complaint management</p>
              </div>
            </div>
            <div className="flex space-x-4">
              <button
                onClick={() => router.push("/admincorner/complaints/analytics")}
                        ...
                        <tr key={complaint.complaintId} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                          ...
                          <td className="px-6 py-4 text-right">
                            <div className="flex items-center justify-end space-x-2">
                              <button
                                onClick={() => router.push(`/admincorner/complaints/${complaint.complaintId}`)}
